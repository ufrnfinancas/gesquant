...
arquivo = 'inf_diario_fi_202505.csv'
link = 'https://dados.cvm.gov.br/dados/FI/DOC/INF_DIARIO/DADOS/inf_diario_fi_202505.zip'
...
selecao = cadastral[cadastral['DENOM_SOCIAL'].str.contains('prev', case=False)]  # Termo a ser buscado na denominação
